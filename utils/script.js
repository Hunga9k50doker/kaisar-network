...
function updateMiningPoint(extensionId, miningData) {
  ...
  logger(`[${extensionId}] Points: ${points}, MiningPoints: ${miningPoint}, ElapsedTimeInHours: ${elapsedTimeInHours}`, "success");
}
...
function updateProgress(extensionId, miningData) {
  ...
  logger(`[${extensionId}] Progress: endTime: ${endTime}, currentTime: ${currentTime}, remainingTime: ${remainingTime}`, "success");
}
